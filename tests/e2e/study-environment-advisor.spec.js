...
const SVC_URL = "https://appadaycreator.com/study-environment-advisor/";
const SVC_NAME = "勉強・集中環境診断";

test.describe("勉強・集中環境診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("study-environment-advisor");
